...
final class MiddlewareClassifierTest {
    ...
    void resolvesAStageInheritedFromAnAbstractBase() {
        var sources =
                Map.of(
                        "p.Child",
                        "package p; class Child extends p.Base {}",
                        "p.Base",
                        "package p; import v.RouteMatchedMiddlewareContract;"
    ...
    void resolvesAStageThroughACustomSubContract() {
        var sources =
                Map.of(
                        ...
                        "p.Uses",
                        "package p; class Uses implements Custom {}");
    ...
    void classifiesAClassThatImplementsNoStageAsEmpty() {
        var sources = Map.of("p.None", "package p; class None implements java.io.Serializable {}");
    ...
    void classifiesAnAncestorInTheDefaultPackage() {
        ...
        var sources =
                Map.of("Default", "class Default implements RouteMatchedMiddlewareContract {}");
